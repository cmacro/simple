...
type
  TTransformationKind = (tkDingy, tkDirty, tkFade, tkMakeMask, tkOpaque, tkAlpha, tkDiable);
...
function TransformBitmap(ABmp: TBitmap; AKind: TTransformationKind):Boolean;
const
  TRANSFORMFUNS: array [TTransformationKind] of TTransformationFun = (Dingy, Dirty, Fade, MakeMask, SetOpaque, ResetAlpha, Disable);
var
  rColors: TRGBColors;
  I, j: Integer;
