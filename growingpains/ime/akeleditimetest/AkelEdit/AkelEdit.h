...
typedef struct {
  ...
  DWORD dwTextLen;    //Text length. If this value is ?, the string is assumed to be null-terminated and the length is calculated automatically.
  BOOL bColumnSel;    //Column selection
} AEAPPENDTEXTA;
...
(DWORD)wParam  == text length. If this value is ?, the string is assumed to be null-terminated and the length is calculated automatically.
